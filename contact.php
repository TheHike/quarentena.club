...
<head>
        <meta charset="utf-8" />
        <title>Quarentena: Contact Page</title>
        ...
        <div id="layout-wrapper">
                                ...
                                <div class="container-fluid">
                                  ...
                                  <div class="row">
                                      <div class="col-12">
                                          <div class="card">
                                              <div class="card-body">
                                        <center><h3> Alguma dúvida contact discord -> <b> TheHike#3377 </b></center></h3>
                  					  </div>
                                       </div>
                                      </div>
                                  </div>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script><b> © Hike & Samurai.</b> 
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-right d-none d-sm-block">
               Fuck design, all my homies hate designers , pasted frontend                                </div>
                            </div>
                        </div>
                    </div>
                </footer>
